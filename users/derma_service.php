...
<section class="hero" style="background: url('<?= BASE_URL ?>/public/images/derma_service.png') center/cover no-repeat;">
      ...
      <div class="carousel-track" id="carouselTrack">
        <div class="service-card">
          <div class="card-img-wrap">
            <img src="<?= BASE_URL ?>/public/images/pimple.jpg" alt="Acne Treatment"/>
            <div class="card-overlay">
              ...
              <a href="<?= BASE_URL ?>/users/appointment.php?service=Acne+Treatment" class="btn-learn">Book Appointment</a>
            </div>
          </div>
        ...
        <div class="service-card">
          <div class="card-img-wrap">
            <img src="<?= BASE_URL ?>/public/images/skin_consult.jpg" alt="Skin Consultation"/>
            <div class="card-overlay">
              ...
              <a href="<?= BASE_URL ?>/users/appointment.php?service=Skin+Consultation" class="btn-learn">Book Appointment</a>
            </div>
          </div>
        ...
        <div class="service-card">
          <div class="card-img-wrap">
            <img src="<?= BASE_URL ?>/public/images/rash.jpg" alt="Allergy / Rash Treatment"/>
            <div class="card-overlay">
              ...
              <span class="card-price">₱500</span>
              <a href="<?= BASE_URL ?>/users/appointment.php?service=Allergy+%2F+Rash+Treatment" class="btn-learn">Book Appointment</a>
            </div>
          </div>
        ...
        <div class="service-card">
          <div class="card-img-wrap">
            <img src="<?= BASE_URL ?>/public/images/psoriasis.jpg" alt="Eczema & Psoriasis Care"/>
            <div class="card-overlay">
              ...
              <a href="<?= BASE_URL ?>/users/appointment.php?service=Eczema+%26+Psoriasis+Care" class="btn-learn">Book Appointment</a>
            </div>
          </div>
        ...
        <div class="service-card">
          <div class="card-img-wrap">
            <img src="<?= BASE_URL ?>/public/images/wart.jpg" alt="Wart / Mole Removal"/>
            <div class="card-overlay">
              <h3>Wart / Mole Removal</h3>
              <p>Effective removal of warts and moles for cosmetic and health reasons.</p>
              <span class="card-price">₱500</span>
              <a href="<?= BASE_URL ?>/users/appointment.php?service=Wart+%2F+Mole+Removal" class="btn-learn">Book Appointment</a>
            </div>
          </div>
        ...
        <div class="service-card">
          <div class="card-img-wrap">
            <img src="<?= BASE_URL ?>/public/images/cehemical_peel.jpg" alt="Chemical Peel / Facial Treatments"/>
            <div class="card-overlay">
              ...
              <span class="card-price">₱500</span>
              <a href="<?= BASE_URL ?>/users/appointment.php?service=Chemical+Peel+%2F+Facial+Treatments" class="btn-learn">Book Appointment</a>
            </div>
          </div>
          <div class="card-label">Chemical Peel / Facial Treatments</div>
                ...
                <div class="service-card">
          <div class="card-img-wrap">
            <img src="<?= BASE_URL ?>/public/images/hair.jpg" alt="Hair Loss Treatment"/>
            <div class="card-overlay">
              <h3>Hair Loss Treatment</h3>
              <p>Specialized treatment for hair loss to help restore and maintain healthy hair.</p>
              <span class="card-price">₱500</span>
              <a href="<?= BASE_URL ?>/users/appointment.php?service=Hair+Loss+Treatment" class="btn-learn">Book Appointment</a>
            </div>
          </div>
