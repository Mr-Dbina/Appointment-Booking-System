        ...
        <div class="service-card">
          <div class="card-img-wrap">
            ...
            <div class="card-overlay">
              ...
              <a href="<?= $base ?>/users/appointment.php?service=Prenatal+Check-up" class="btn-learn">Book Appointment</a>
            </div>
          </div>
        ...
        <div class="service-card">
          <div class="card-img-wrap">
            ...
            <div class="card-overlay">
              ...
              <span class="card-price">₱500</span>
              <a href="<?= $base ?>/users/appointment.php?service=Ultrasound" class="btn-learn">Book Appointment</a>
            </div>
          </div>
        ...
        <div class="service-card">
          <div class="card-img-wrap">
            ...
            <div class="card-overlay">
              ...
              <span class="card-price">₱500</span>
              <a href="<?= $base ?>/users/appointment.php?service=Family+Planning" class="btn-learn">Book Appointment</a>
            </div>
          </div>
        ...
        <div class="service-card">
          <div class="card-img-wrap">
            ...
            <div class="card-overlay">
              ...
              <span class="card-price">₱500</span>
              <a href="<?= $base ?>/users/appointment.php?service=Menstrual+Problems+Consultation" class="btn-learn">Book Appointment</a>
            </div>
          </div>
        ...
        <div class="service-card">
          <div class="card-img-wrap">
            ...
            <div class="card-overlay">
              ...
              <span class="card-price">₱500</span>
              <a href="<?= $base ?>/users/appointment.php?service=Pregnancy+Test+%26+Monitoring" class="btn-learn">Book Appointment</a>
            </div>
          </div>
        ...
        <div class="service-card">
          <div class="card-img-wrap">
            ...
            <div class="card-overlay">
              ...
              <span class="card-price">₱500</span>
              <a href="<?= $base ?>/users/appointment.php?service=Pap+Smear+%2F+Cervical+Screening" class="btn-learn">Book Appointment</a>
            </div>
          </div>
