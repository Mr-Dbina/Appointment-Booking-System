...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="http://localhost/appointment_booking_system/public/css/footer.css"
    />
  </head>
  <body>
    <footer>
      <div class="footer-grid">
        ...
        <div class="footer-col">
          ...
          <ul>
            <li>
              <a
                href="http://localhost/appointment_booking_system/app/views/users/ob_service.php"
                >OB-GYN</a
              >
            </li>
            <li>
              <a
                href="http://localhost/appointment_booking_system/app/views/users/gen_service.php"
                >General Medicine</a
              >
            </li>
            <li>
              <a
                href="http://localhost/appointment_booking_system/app/views/users/ped_service.php"
                >Pediatrics</a
              >
            </li>
            <li>
              <a
                href="http://localhost/appointment_booking_system/app/views/users/derma_service.php"
                >Dermatology</a
              >
            </li>
          </ul>
