        ...
        <div class="service-card">
          <div class="card-img-wrap">
            ...
            <div class="card-overlay">
              ...
              <a href="<?= $base ?>/app/views/users/appointment.php?service=Acne+Treatment" class="btn-learn">Book Appointment</a>
            </div>
          </div>
        ...
        <div class="service-card">
          <div class="card-img-wrap">
            ...
            <div class="card-overlay">
              ...
              <a href="<?= $base ?>/app/views/users/appointment.php?service=Skin+Consultation" class="btn-learn">Book Appointment</a>
            </div>
          </div>
        ...
        <div class="service-card">
          <div class="card-img-wrap">
            ...
            <div class="card-overlay">
              ...
              <span class="card-price">₱500</span>
              <a href="<?= $base ?>/app/views/users/appointment.php?service=Allergy+%2F+Rash+Treatment" class="btn-learn">Book Appointment</a>
            </div>
          </div>
        ...
        <div class="service-card">
          <div class="card-img-wrap">
            ...
            <div class="card-overlay">
              ...
              <a href="<?= $base ?>/app/views/users/appointment.php?service=Eczema+%26+Psoriasis+Care" class="btn-learn">Book Appointment</a>
            </div>
          </div>
        ...
        <div class="service-card">
          <div class="card-img-wrap">
            ...
            <div class="card-overlay">
              ...
              <span class="card-price">₱500</span>
              <a href="<?= $base ?>/app/views/users/appointment.php?service=Wart+%2F+Mole+Removal" class="btn-learn">Book Appointment</a>
            </div>
          </div>
        ...
        <div class="service-card">
          <div class="card-img-wrap">
            ...
            <div class="card-overlay">
              ...
              <span class="card-price">₱500</span>
              <a href="<?= $base ?>/app/views/users/appointment.php?service=Chemical+Peel+%2F+Facial+Treatments" class="btn-learn">Book Appointment</a>
            </div>
          </div>
          ...
          <div class="card-img-wrap">
            ...
            <div class="card-overlay">
              ...
              <span class="card-price">₱500</span>
              <a href="<?= $base ?>/app/views/users/appointment.php?service=Hair+Loss+Treatment" class="btn-learn">Book Appointment</a>
            </div>
          </div>
