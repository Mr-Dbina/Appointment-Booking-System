...
function send_mail(
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'YOUR_GMAIL_HERE@gmail.com';
        $mail->Password   = 'YOUR_APP_PASSWORD_HERE';
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port       = 587;

        $mail->setFrom('YOUR_GMAIL_HERE@gmail.com', 'Happy Care Clinic');
        $mail->addAddress($toEmail, $toName);
        $mail->addReplyTo('YOUR_GMAIL_HERE@gmail.com', 'Happy Care Clinic');
